...
if($error==0){
	include 'C:/wamp64/www/medT8/BD/form/hotline/send_kabinet.php';
}
?>
	<input type="button" id="btn2" class="bb1" value="Повторить ввод" onClick=reset();loadpage('form/hotline/kabinet.php'); /><br>
	<?php
}
?>
<br>
