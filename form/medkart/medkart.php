...
<form method="post" id="ajax_form"  action="">
  ...
  <p><b>Введите значения</b><br>
      <input type="date" name="begin" size="40" placeholder="Дата посещения" maxlength="30"><br><br>
      <input type="text" name="diag" placeholder="Диагнос" maxlength="30" ><br><br>
  ...
  pac: {
   ...
   submitHandler: function() {
        ...
        jQuery.ajax({    
            ...
            url: 'form/medkart/action_ajax_medkart_form.php', // Адрес обработчика
            beforeSend: function(){
